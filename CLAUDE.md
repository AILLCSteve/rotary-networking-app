...
**SOLID** = 5 object-oriented design principles that improve maintainability and flexibility.
...
Key elements: **Ubiquitous Language**, **Entities**, **Value Objects**, **Aggregates**, **Bounded Contexts**.
